package com.example.firebasedemo.zalopaymentandroid.Helper;
...
public class Helpers {
    ...
    @NotNull
    public static String getMac(@NotNull String key, @NotNull String data) throws InvalidKeyException {
        String mac = HMacUtil.HMacHexStringEncode(HMacUtil.HMACSHA256, key, data);
        if (mac == null) {
            throw new InvalidKeyException("MAC generation failed");
        }
        return mac;
    }
